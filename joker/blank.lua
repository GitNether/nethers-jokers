function check_if_joker_is_still_there(card)
...
SMODS.Joker{
    ...
    set_sprites = function(self, card, front)
        ...
        set_new_joker_sprite(card, check_if_joker_is_still_there(card))
    end,
    loc_vars = function(self, info_queue, card)
        check_if_joker_is_still_there(card)
    ...
    calculate = function(self, card, context)
        ...
        if context.selling_card then
            other_joker = check_if_joker_is_still_there(card)
            if other_joker then
